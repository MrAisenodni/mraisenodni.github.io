...
$okMessage = 'Pesan berhasil dikirim. Terima kasih.';
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    if($responseData->success):
        ...
        try
        {
            $emailText = nl2br("Kamu mendapatkan email dari Formulir Kontak\n");
        ...
        $errorMessage = 'Gagal verifikasi robot, tolong ulangi.';
        $responseArray = array('type' => 'danger', 'message' => $errorMessage);
        $encoded = json_encode($responseArray);
    ...
    $errorMessage = 'Tolong klik kotak CAPTCHA kembali.';
    $responseArray = array('type' => 'danger', 'message' => $errorMessage);
    $encoded = json_encode($responseArray);
